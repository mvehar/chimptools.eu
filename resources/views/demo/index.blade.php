...
@section('rightbar-content')
    ...
    <div class="contentbar">
        ...
        <div class="row">
                        ...
                        <div class="card m-b-15">
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-3">
                                        <div class="dropdown">
                                            <button class="btn btn-link p-0 font-18 float-right" type="button" id="widgetRevenue" data-toggle="dropdown"
                                                    aria-haspopup="true" aria-expanded="false"><i class="feather icon-more-horizontal-"></i></button>
            ...
            <!-- Start col -->
            <div class="col-lg-12 col-xl-6">
                <div class="card m-b-15 dash-widget">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-5">
                            ...
                            <div class="col-7">
                                <ul class="nav nav-pills float-right" id="pills-index-tab-justified" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="pills-sales-tab-justified" data-toggle="pill" href="#pills-sales-justified" role="tab"
                                           aria-selected="true">Sales</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="pills-clients-tab-justified" data-toggle="pill" href="#pills-clients-justified" role="tab"
                        ...
                        <div class="card m-b-15">
                            ...
                            <div class="card-body">
                                ...
                                <div class="progress mb-1" style="height: 4px;">
                                    <div class="progress-bar bg-secondary" role="progressbar" style="width: 50%;" aria-valuenow="50" aria-valuemin="0"
                                         aria-valuemax="100"></div>
                                </div>
                            </div>
                                ...
                                <div class="avatar-group">
                                    <div class="avatar">
                                        <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Amy Adams">
                                            <img src="{{asset('assets/images/users/men.svg" alt="avatar" class="rounded-circle">
                                        </a>
                                    </div>
                                    <div class="avatar">
                                        <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Amy Adams">
                            ...
                            <div class="card-body text-center">
                                <div class="user-slider">
                                    <div class="user-slider-item">
                                        <img src="{{asset('assets/images/users/men.svg" alt="avatar" class="rounded-circle mt-3 mb-4">
                                        <h5>James Smith</h5>
                                        <p>Senior Sales Executive</p>
                                        <p>55 Avenue, North Street Road, Carolina State, New York City, USA</p>
                                    </div>
                                    <div class="user-slider-item">
                                        <img src="{{asset('assets/images/users/women.svg" alt="avatar" class="rounded-circle mt-3 mb-4">
                                        <h5>James Smith</h5>
                                        <p>Senior Sales Executive</p>
                                        <p>55 Avenue, North Street Road, Carolina State, New York City, USA</p>
                                    </div>
                                    <div class="user-slider-item">
                                        <img src="{{asset('assets/images/users/girl.svg" alt="avatar" class="rounded-circle mt-3 mb-4">
                                        <h5>James Smith</h5>
                                        <p>Senior Sales Executive</p>
                                        <p>55 Avenue, North Street Road, Carolina State, New York City, USA</p>
                                    </div>
                        ...
                        <div class="card m-b-15">
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-3">
                                        <div class="dropdown">
                                            <button class="btn btn-link p-0 font-18 float-right" type="button" id="widgetPerformers" data-toggle="dropdown"
                                                    aria-haspopup="true" aria-expanded="false"><i class="feather icon-more-horizontal-"></i></button>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-borderless">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td><img src="{{asset('assets/images/users/men.svg" class="img-fluid" width="35" alt="customer"></td>
                                            <td>John Doe</td>
                                        ...
                                        <tr>
                                            <td><img src="{{asset('assets/images/users/women.svg" class="img-fluid" width="35" alt="customer"></td>
                                            <td>Daniel Chris</td>
                                            <td>demo@example.com</td>
                                            <td>93%</td>
                                            <td>1300</td>
                                        ...
                                        <tr>
                                            <td><img src="{{asset('assets/images/users/boy.svg" class="img-fluid" width="35" alt="customer"></td>
                                            <td>John Joshua</td>
                                            <td>demo@example.com</td>
                                            <td>87%</td>
                                            <td>1250</td>
                ...
                <div class="card m-b-15">
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-3">
                                <div class="dropdown">
                                    <button class="btn btn-link p-0 font-18 float-right" type="button" id="widgetLeads" data-toggle="dropdown" aria-haspopup="true"
