                ...
                <div class="card m-b-15">
                    ...
                    <div class="card-body">
                        <div id="kanban-board-one">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right"
                                                        ...
                                                        <a class="dropdown-item" href="#"><i
                                                                class="feather icon-refresh-ccw mr-2"></i>Sync</a>
                                                        <a class="dropdown-item" href="#"><i
                                                                class="feather icon-edit-2 mr-2"></i>Edit</a>
                                                        <a class="dropdown-item" href="#"><i
                                            ...
                                            <div class="kanban-users">
                                                <div class="avatar-group">
                                                    <div class="avatar">
                                                        <a href="#" data-toggle="tooltip" data-placement="top" title=""
                                                           data-original-title="Amy Adams">
                                                            <img src="{{asset('assets/images/users/men.svg')}}"
                                                    ...
                                                    <div class="avatar">
                                                        <a href="#" data-toggle="tooltip" data-placement="top" title=""
                                                           data-original-title="Amy Adams">
                                                            <img src="{{asset('assets/images/users/women.svg')}}"
                                                                 alt="avatar" class="rounded-circle">
                                                        </a>
                                                    </div>
                                                    <div class="avatar">
                                                        <a href="#" data-toggle="tooltip" data-placement="top" title=""
                                                           data-original-title="Amy Adams">
                                                            <img src="{{asset('assets/images/users/boy.svg')}}"
                                                                 alt="avatar" class="rounded-circle">
                                                        </a>
                                                    </div>
                                                </div>
                            ...
                            <div class="card border m-b-20">
                                <div class="card-body">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-12">
                                            <h5 class="font-16 my-3">Create wireframes for upcoming web development
                                                project</h5>
                                        </div>
                                    </div>
                                    <div class="row align-items-center">
                            ...
                            <div class="card border m-b-20">
                                <div class="card-body">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-12">
                                            <h5 class="font-16 my-3">Create final draft for Live Podcast Strategy, along
                                                with initial presentation.</h5>
                                        </div>
                                    </div>
                                    <div class="row align-items-center">
                                        <div class="col-5">
                            ...
                            <div class="card border m-b-20">
                                <div class="card-body">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-12">
                                            <h5 class="font-16 my-3">Process Form 16 of the Employees for Income Tax
                                                Return.</h5>
                                        </div>
                                    </div>
                                    <div class="row align-items-center">
                        ...
                        <button type="button" class="btn btn-primary-rgba btn-block btn-lg font-16"><i
                                class="feather icon-plus mr-2"></i>Add Task
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div class="card m-b-15">
                    ...
                    <div class="card-body">
                        <div id="kanban-board-two">
                            ...
                            <div class="card border m-b-20">
                                <img class="card-img-top" src="{{asset('assets/images/ui-cards/ui-cards-1.jpg')}}"
                                     alt="Card image cap">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-8">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-12">
                                            <h5 class="font-16 my-3">Change in angle of few photos from Photoshoot
                                                No.5</h5>
                                        </div>
                                    </div>
                                    <div class="row align-items-center">
                        ...
                        <div id="kanban-board-three">
                            <div class="card border m-b-20">
                                <div class="card-body">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-12">
                                            <h5 class="font-16 my-3">Get budget approved with Sam for Saturday Company
                                                outing.</h5>
                                        </div>
                                    </div>
                                    <div class="row align-items-center">
                            ...
                            <div class="card border m-b-20">
                                <img class="card-img-top" src="{{asset('assets/images/ui-cards/ui-cards-2.jpg')}}"
                                     alt="Card image cap">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-8">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-12">
                                            <h5 class="font-16 my-3">Upload New Commercial Video for online
                                                promotions.</h5>
                                        </div>
                                    </div>
                                    <div class="row align-items-center">
                            ...
                            <div class="card border m-b-20">
                                <div class="card-body">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-12">
                                            <h5 class="font-16 my-3">Update slider images on www.theta.com for New
                                                Event.</h5>
                                        </div>
                                    </div>
                                    <div class="row align-items-center">
                ...
                <div class="card m-b-15">
                    ...
                    <div class="card-body">
                        <div id="kanban-board-four">
                            <div class="card border m-b-20">
                                <img class="card-img-top" src="{{asset('assets/images/ui-cards/ui-cards-3.jpg')}}"
                                     alt="Card image cap">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-8">
                                            ...
                                            <div class="kanban-menu">
                                                <div class="dropdown">
                                                    <button class="btn btn-link p-0 m-0 border-0 l-h-20 font-16"
                                                            ...
                                                            class="feather icon-more-vertical-"></i></button>
                                                    <div class="dropdown-menu dropdown-menu-right"
                                                         aria-labelledby="KanbanBoardButton11">
                                                        <a class="dropdown-item" href="#"><i
                                                                class="feather icon-refresh-ccw mr-2"></i>Sync</a>
                                                        <a class="dropdown-item" href="#"><i
                                                                class="feather icon-edit-2 mr-2"></i>Edit</a>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-12">
                                            <h5 class="font-16 my-3">Product #985, #987 need to be retouched for
                                                reflection settings.</h5>
                                        </div>
                                    </div>
                                    <div class="row align-items-center">
                                        <div class="col-5">
