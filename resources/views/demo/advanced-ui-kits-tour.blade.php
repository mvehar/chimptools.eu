...
<div class="contentbar">
    ...
    <div class="row tourbar">
        <!-- Start col -->
        <div class="col-lg-12">
            <div class="card m-b-15" id="tour-form">
        ...
        <div class="col-md-6 col-lg-6 col-xl-3">
            <div class="card m-b-15" id="tour-card">
        ...
        <!-- Start col -->
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="card m-b-15" id="tour-upload">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-8">
                ...
                <div class="card-body">
                    <div class="ecommerce-upload">
                        ...
                        <img src="{{asset('assets/images/dashboard/cloud.svg" class="img-fluid" alt="colud">
                    </div>
                </div>
            </div>
        </div>
