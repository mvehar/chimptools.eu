...
<div class="contentbar">
    ...
    <div class="row">
        ...
        <!-- Start col -->
        <div class="col-md-6 col-lg-6 col-xl-4">
            <div class="card text-right m-b-15">
                <div class="card-body">
                    <h5 class="card-title font-18">Special title treatment</h5>
                    <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                    <a href="#" class="btn btn-primary">Go somewhere</a>
        ...
        <div class="col-md-12 col-lg-12 col-xl-4">
            <div class="card text-white bg-primary m-b-15">
                <div class="card-body">
        ...
        <!-- Start col -->
        <div class="col-md-6 col-lg-6 col-xl-3">
            <div class="card text-white bg-secondary m-b-15">
                <div class="card-header">Header</div>
                <div class="card-body">
        ...
        <!-- Start col -->
        <div class="col-md-6 col-lg-6 col-xl-3">
            <div class="card text-white bg-success m-b-15">
                <div class="card-header">Header</div>
                <div class="card-body">
        ...
        <!-- Start col -->
        <div class="col-md-6 col-lg-6 col-xl-3">
            <div class="card text-white bg-danger m-b-15">
                <div class="card-header">Header</div>
                <div class="card-body">
        ...
        <!-- Start col -->
        <div class="col-md-6 col-lg-6 col-xl-3">
            <div class="card text-white bg-warning m-b-15">
                <div class="card-header">Header</div>
                <div class="card-body">
        ...
        <!-- Start col -->
        <div class="col-md-6 col-lg-6 col-xl-3">
            <div class="card text-white bg-info m-b-15">
                <div class="card-header">Header</div>
                <div class="card-body">
        ...
        <!-- Start col -->
        <div class="col-md-6 col-lg-6 col-xl-3">
            <div class="card text-white bg-dark m-b-15">
                <div class="card-header">Header</div>
                <div class="card-body">
        ...
        <!-- Start col -->
        <div class="col-md-6 col-lg-6 col-xl-3">
            <div class="card border-primary m-b-15">
                <div class="card-header">Header</div>
        ...
        <!-- Start col -->
        <div class="col-md-6 col-lg-6 col-xl-3">
            <div class="card border-secondary m-b-15">
                <div class="card-header">Header</div>
        ...
        <!-- Start col -->
        <div class="col-md-6 col-lg-6 col-xl-3">
            <div class="card border-success m-b-15">
                <div class="card-header">Header</div>
        ...
        <!-- Start col -->
        <div class="col-md-6 col-lg-6 col-xl-3">
            <div class="card border-danger m-b-15">
                <div class="card-header">Header</div>
        ...
        <!-- Start col -->
        <div class="col-md-6 col-lg-6 col-xl-3">
            <div class="card border-warning m-b-15">
                <div class="card-header">Header</div>
        ...
        <!-- Start col -->
        <div class="col-md-6 col-lg-6 col-xl-3">
            <div class="card border-info m-b-15">
                <div class="card-header">Header</div>
        ...
        <!-- Start col -->
        <div class="col-md-6 col-lg-6 col-xl-3">
            <div class="card border-light m-b-15">
                <div class="card-header">Header</div>
                <div class="card-body">
                    <h5 class="card-title">Light card title</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
        ...
        <!-- Start col -->
        <div class="col-md-6 col-lg-6 col-xl-3">
            <div class="card border-dark m-b-15">
                <div class="card-header">Header</div>
