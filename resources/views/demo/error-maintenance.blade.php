...
<head>
    ...
    <title>Chimptools.eu - Maintenance</title>
    <!-- Fevicon -->
                 ...
                 <div class="row no-gutters align-items-center justify-content-center">
                    ...
                    <div class="col-md-8 col-lg-6">
                        <div class="text-center">
                            <img src="logo.png" class="img-fluid error-logo" alt="logo">
                            <img src="{{asset('assets/images/error/maintenance.svg" class="img-fluid error-image" alt="maintenance">
