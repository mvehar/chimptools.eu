                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="product-bar m-b-15">
                                <div class="product-head">
                                    <a href="{{url('/ecommerce-single-product')}}"><img src="{{asset('assets/images/ecommerce/product_img_01.jpg" class="img-fluid" alt="product"></a>
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="product-bar m-b-15">
                                <div class="product-head">
                                    <a href="{{url('/ecommerce-single-product')}}"><img src="{{asset('assets/images/ecommerce/product_img_02.jpg" class="img-fluid" alt="product"></a>
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="product-bar m-b-15">
                                <div class="product-head">
                                    <a href="{{url('/ecommerce-single-product')}}"><img src="{{asset('assets/images/ecommerce/product_img_03.jpg" class="img-fluid" alt="product"></a>
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="product-bar m-b-15">
                                <div class="product-head">
                                    <a href="{{url('/ecommerce-single-product')}}"><img src="{{asset('assets/images/ecommerce/product_img_04.jpg" class="img-fluid" alt="product"></a>
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="product-bar m-b-15">
                                <div class="product-head">
                                    <a href="{{url('/ecommerce-single-product')}}"><img src="{{asset('assets/images/ecommerce/product_img_05.jpg" class="img-fluid" alt="product"></a>
                        ...
                        <div class="col-lg-6 col-xl-4">
                            <div class="product-bar m-b-15">
                                <div class="product-head">
                                    <a href="{{url('/ecommerce-single-product')}}"><img src="{{asset('assets/images/ecommerce/product_img_06.jpg" class="img-fluid" alt="product"></a>
