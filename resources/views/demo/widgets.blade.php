                ...
                <div class="card-body text-center">
                    <div class="user-slider">
                        <div class="user-slider-item">
                            <img src="{{asset('assets/images/users/boy.svg" alt="avatar" width="100px" class="rounded-circle mt-3 mb-4">
                            <h5>James Smith</h5>
                ...
                <div class="card-body">
                    <div class="best-product-slider">
                        <div class="best-product-slider-item">
                            <div class="row">
                                <div class="col-sm-4">
                                    <img src="{{asset('assets/images/ecommerce/produc_slider1.png" class="img-fluid" alt="product">
                                </div>
                                <div class="col-sm-8">
