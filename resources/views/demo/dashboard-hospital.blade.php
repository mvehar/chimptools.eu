                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="avatar-group">
                                            ...
                                            <div class="avatar">
                                                <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Amy Adams">
                                                    <img src="{{asset('assets/images/users/boy.svg" alt="avatar" class="rounded-circle">
                                                </a>
                                            </div>
                                        </div>
                                    </td>
            ...
            <div class="card m-b-15">
                ...
                <div class="card-body py-0">
                    <ul class="list-unstyled">
                        <li class="media">
                            <img class="mr-3 rounded-circle" src="{{asset('assets/images/users/men.svg" alt="Generic placeholder image">
            ...
            <div class="card m-b-15">
                <div class="blog-slider">
                    <div class="blog-slider-item">
                        <img class="card-img-top" src="{{asset('assets/images/blog/blog_slide_01.jpg" alt="Card image cap">
                        <div class="card-body">
                    ...
                    <div class="blog-slider-item">
                        <img class="card-img-top" src="{{asset('assets/images/blog/blog_slide_02.jpg" alt="Card image cap">
                        <div class="card-body">
                    ...
                    <div class="blog-slider-item">
                        <img class="card-img-top" src="{{asset('assets/images/blog/blog_slide_03.jpg" alt="Card image cap">
                        <div class="card-body">
