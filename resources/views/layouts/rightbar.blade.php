        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                <div class="mobile-logobar">
                    <a href="{{url('/')}}" class="mobile-logo"><img src="/logo.png" class="img-fluid" alt="logo"></a>
                </div>
                                ...
                                <form>
                                    <div class="input-group">
                                        <input type="search" class="form-control" placeholder="Search"
                                               aria-label="Search" aria-describedby="button-addon2" name="s"
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="profilelink">
                                        ...
                                        <div class="userbox">
                                            <ul class="list-unstyled mb-0">
                                                ...
                                                {{--                                                </li>--}}
                                                <li class="media dropdown-item">
                                                    <a href="{{route('logout.get')}}" class="profile-icon"><img
...
<!-- Start Footerbar -->
    <div class="footerbar">
        <footer class="footer">
            <p class="mb-0">© {{date('Y')}} vehar.eu - All Rights Reserved.</p>
        </footer>
    </div>
    <!-- End Footerbar -->
</div>
