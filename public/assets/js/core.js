/*
 --------------------------------------------------------------
 Template Name: Chimptools.eu - Responsive Admin Dashboard Template
 File: Core JS File
 --------------------------------------------------------------
 */
'use strict';
$(document).ready(function() {
    ...
    $(function() {
        for (var a = window.location, abc = $('.vertical-menu a').
        filter(function() {
            return this.href == a;
        }).
        addClass('active').
    ...
    $('#infobar-settings-open').on('click', function(e) {
        ...
        css({'background': 'rgba(0,0,0,0.4)', 'position': 'fixed'});
        $('#infobar-settings-sidebar').addClass('sidebarshow');
    });
    $('#infobar-settings-close').on('click', function(e) {
        e.preventDefault();
        $('.infobar-settings-sidebar-overlay').
        css({'background': 'transparent', 'position': 'initial'});
